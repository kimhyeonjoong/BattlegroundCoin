			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="mywallet.jsp" id="logo">My Wallet</a></h1>
							</header>
						</div>
						...
						<nav id="nav">
							<ul>
								...
								<li>
									...
									<ul>
										<li><a href="mywellet.jsp">My Wallet</a></li>
						...
						<div class="row 200%">
							<div class="4u 12u(mobile)" id="sidebar">
								...
								<section>
									...
									<div class="row 50%">
										<div class="4u">
											<a href="#" class="image fit"><img src="images/minus.png" alt="" /></a>
										</div>
										<div class="8u">
									...
									<footer>
										<a href="#" class="button">View more list</a>
									</footer>
								</section>
							</div>
